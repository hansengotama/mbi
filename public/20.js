...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    confirmationDeleteDistrict: function confirmationDeleteDistrict(data) {
      ...
      _helper_alert__WEBPACK_IMPORTED_MODULE_1__["default"].confirmation('Apakah kamu yakin untuk menghapus kabupaten ' + data.name + ' ?', 'Hapus', 'Tidak').then(function (dialog) {
