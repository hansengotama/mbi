...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    validateDetail: function validateDetail() {
      var validate = true;

      for (var i = 0; i < this.formData.detail.length; i++) {
        if (_helper_validator__WEBPACK_IMPORTED_MODULE_1__["default"].required(this.formData.detail[i].date_until)) {
          validate = false;
        ...
        if (_helper_validator__WEBPACK_IMPORTED_MODULE_1__["default"].required(this.formData.detail[i].date_from)) {
          validate = false;
    ...
    removeDetail: function removeDetail(index) {
      if (this.formData.detail.length <= 1) _helper_alert__WEBPACK_IMPORTED_MODULE_3__["default"].error();else {
...
var render = function() {
  ...
  return _c("div", { staticClass: "event-form" }, [
    ...
    _c("div", { staticClass: "form-detail-container" }, [
      _c(
        "div",
        { staticClass: "label", staticStyle: { "margin-top": "10px" } },
        [_vm._v("\n            Rincian\n        ")]
      ),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "detail" },
        _vm._l(_vm.formData.detail, function(data, index) {
          return _c("div", { key: index, staticClass: "detail-container" }, [
            _c("div", { staticClass: "from" }, [
              _c("div", { staticClass: "date" }, [
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.formData.detail[index].date_from,
                      expression: "formData.detail[index].date_from"
                    }
                  ],
                  class: _vm.error.class.detail[index].date_from,
                  attrs: { type: "date" },
                  domProps: { value: _vm.formData.detail[index].date_from },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                ...
                _vm._v(" "),
                _c("small", { staticClass: "red" }, [
                  _vm._v(_vm._s(_vm.error.message.detail[index].date_from))
                ])
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "time" }, [
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.formData.detail[index].time_from,
                      expression: "formData.detail[index].time_from"
                    }
                  ],
                  class: _vm.error.class.detail[index].time_from,
                  attrs: { type: "time" },
                  domProps: { value: _vm.formData.detail[index].time_from },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                ...
                _vm._v(" "),
                _c("small", { staticClass: "red" }, [
                  _vm._v(_vm._s(_vm.error.message.detail[index].time_from))
                ])
              ])
            ]),
            _vm._v(" "),
            ...
            _c("div", { staticClass: "until" }, [
              _c("div", { staticClass: "date" }, [
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.formData.detail[index].date_until,
                      expression: "formData.detail[index].date_until"
                    }
                  ],
                  class: _vm.error.class.detail[index].date_until,
                  attrs: { type: "date" },
                  domProps: { value: _vm.formData.detail[index].date_until },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                ...
                _vm._v(" "),
                _c("small", { staticClass: "red" }, [
                  _vm._v(_vm._s(_vm.error.message.detail[index].date_until))
                ])
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "time" }, [
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.formData.detail[index].time_until,
                      expression: "formData.detail[index].time_until"
                    }
                  ],
                  class: _vm.error.class.detail[index].time_until,
                  attrs: { type: "time" },
                  domProps: { value: _vm.formData.detail[index].time_until },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                ...
                _vm._v(" "),
                _c("small", { staticClass: "red" }, [
                  _vm._v(_vm._s(_vm.error.message.detail[index].time_until))
                ])
              ])
            ]),
            _vm._v(" "),
    ...
    _c("div", { staticStyle: { display: "flex" } }, [
      ...
      _vm._v(" "),
      _c("div", { staticStyle: { flex: "2", "margin-top": "1em" } }, [
        _c(
          "div",
          {
            staticStyle: {
