...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getRegion: function getRegion() {
      ...
      _helper_request__WEBPACK_IMPORTED_MODULE_0__["default"].get('/api/region?filter[text]=' + this.filter.text + '&filter[page]=' + this.filter.page + '&filter[per_page]=' + this.filter.per_page, this.accessToken).then(function (response) {
