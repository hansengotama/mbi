...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getUser: function getUser() {
      ...
      if (this.accessToken) {
        _helper_request__WEBPACK_IMPORTED_MODULE_0__["default"].get('/api/user?filter[text]=' + this.filter.text + '&filter[page]=' + this.filter.page + '&filter[per_page]=' + this.filter.per_page + '&filter[district_id]=' + this.userLogin.district_id, this.accessToken).then(function (response) {
