...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getDeceased: function getDeceased() {
      ...
      _helper_request__WEBPACK_IMPORTED_MODULE_0__["default"].get('/api/deceased?filter[text]=' + this.filter.text + '&filter[page]=' + this.filter.page + '&filter[per_page]=' + this.filter.per_page, this.accessToken).then(function (response) {
        _this.deceased = response.data.result;
      });
    },
